    ...
    return (
        <div className={cn("flex items-center gap-2.5 group select-none", className)}>
            ...
            <div className={cn("relative flex items-center justify-center w-11 h-11", iconClassName)}>
                {/* Layer 1 (Bottom) */}
                <div className="absolute inset-x-1 bottom-1 h-6 bg-brand-from/30 rounded-lg transform skew-x-[-10deg] translate-y-1 group-hover:translate-y-2 transition-transform duration-300" />
                {/* Layer 2 (Middle) */}
                <div className="absolute inset-x-1 bottom-3 h-6 bg-brand-from/60 rounded-lg transform skew-x-[-10deg] translate-y-0.5 group-hover:translate-y-1 transition-transform duration-300 delay-75" />
